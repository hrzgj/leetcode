...
//      }
//
//      private static void dfs(List<Integer> node,int num,List<Integer> list,int index){
//            if(flag){
//              return;
//            }
//            if(num-node.get(index)<0){
//                return;
//            }
//            int nodeNum=node.get(index);
//            list.add(nodeNum);
//          if(num-nodeNum==0){
//              flag=true;
...
//            if(node.size()>left){
//                dfs(node,num-nodeNum,list,left);
//            }
//            if(node.size()>right){
//                dfs(node,num-nodeNum,list,right);
//            }
